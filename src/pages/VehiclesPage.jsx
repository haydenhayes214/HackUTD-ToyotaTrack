...
const HARDCODED_TOYOTA_VEHICLES = [
  ...
  },
  {
    ...
    seats: 2,
    horsepower: 382,
    image: "https://tmna.aemassets.toyota.com/is/image/toyota/toyota/jellies/max/2026/grsupra/mkvfinaledition/2376/d12/36/5.png?fmt=png-alpha&wid=930&hei=328&qlt=90",
    features: ["3.0L Turbo I6 Engine", "8-Speed Automatic", "Adaptive Variable Suspension", "Brembo Brakes", "Active Differential", "Toyota Safety Sense 2.5+"],
    description: "Legendary sports car with track-ready performance, precision handling, and iconic design that delivers pure driving excitement."
  },
  {
    id: "TOY-2025-HIG-XLE-008",
    make: "Toyota",
    ...
    seats: 7,
    horsepower: 295,
    image: "https://tmna.aemassets.toyota.com/is/image/toyota/toyota/jellies/max/2026/grandhighlander/hybridmaxplatinum/6732/1l5/36/5.png?fmt=png-alpha&wid=930&hei=328&qlt=90",
    features: ["3.5L V6 Engine", "8-Speed Automatic", "Toyota Safety Sense 2.5+", "Tri-Zone Climate Control", "Power Liftgate", "Apple CarPlay", "Android Auto"],
    description: "Spacious three-row SUV perfect for families, offering comfort, versatility, and advanced safety features for every adventure."
  },
  {
    id: "TOY-2025-PRI-LE-009",
    make: "Toyota",
    model: "Prius LE",
    trim: "LE",
    year: 2025,
    ...
    seats: 5,
    horsepower: 196,
    image: "https://imageonthefly.autodatadirect.com/images/?width=1200&height=900&IMG=USD30TOC161A01300.jpg",
    features: ["2.0L Hybrid Engine", "eCVT Transmission", "Toyota Safety Sense 3.0", "Solar Roof Option", "Digital Rearview Mirror", "Wireless Charging", "Apple CarPlay"],
    description: "Iconic hybrid with cutting-edge design, exceptional fuel economy, and innovative technology for eco-conscious drivers."
  }
];
